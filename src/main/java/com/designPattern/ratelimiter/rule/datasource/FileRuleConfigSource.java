...
import com.designPattern.ratelimiter.rule.parser.JsonRuleConfigParser;
import com.designPattern.ratelimiter.rule.parser.RuleConfigParser;
import com.designPattern.ratelimiter.rule.parser.YamlRuleConfigParser;
...
public class FileRuleConfigSource implements RuleConfigSource{
    ...
    public RuleConfig load() {
        for (String extension : SUPPORT_EXTENSIONS) {
            InputStream in = null;
            try {
                log.info("resourceFile: /" + getFileNameByExt(extension));
